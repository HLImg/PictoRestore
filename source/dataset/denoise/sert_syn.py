# -*- encoding: utf-8 -*-
# @Author  :  Liang Hao
# @Time    :  2023/10/05 20:12:48
# @FileName:  sert_syn.py
...
class SERTDataset(BaseDataSet):
    def __init__(self, hq_path, scale=1, patch_size=-1, flip=False,
        ...
        super(SERTDataset, self).__init__(scale, patch_size)
        ...
        self.add_noise = AddNoise2HSI(noise_type=noise_type, clip=noise_clip)
